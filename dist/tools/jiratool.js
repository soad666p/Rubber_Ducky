export const getTodoToJirasInstructions = async () => {
    return {
        content: [
            {
                type: "text",
                text: "goes through the all the todos and converts them to jiras, i want to you to chose either that they " +
...
export const getPullToJiraTicketInstructions = async () => {
    return {
        content: [
            {
                type: "text",
                text: "check if the pull request is related to a jira ticket, if it is, then link the pull request to the jira ticket. " +
...
export const getJiraLinterInstructions = async () => {
    return {
        content: [
            {
                type: "text",
                text: "lint the jira tickets and see if they are valid and if they are not valid, fix them. " +
