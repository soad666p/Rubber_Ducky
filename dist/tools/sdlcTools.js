export const getFullSdlcFromJiraInstructions = async () => {
    return {
        content: [
            {
                type: "text",
                text: "Use one Jira ticket as the source of truth and execute an end-to-end SDLC workflow with Jira, GitHub, Slack, and CI/Cypress MCPs. Prefer doing the work, not only describing it.\n\n" +
                    "Execution rules:\n" +
