    ...
    content: [
      {
        type: "text" as const,
        text:
          "who is the owner of the service, look at the code and see who is the owner of the service " +
    ...
    content: [
      {
        type: "text" as const,
        text:
          "check the git history for the last release and see who changed the flags " +
    ...
    content: [
      {
        type: "text" as const,
        text:
          "check slack for incidents; if there is a new incident that has been raised, " +
    ...
    content: [
      {
        type: "text" as const,
        text:
          "using the github mcp and the dependabot tool, check the repository for any CVEs; " +
